...
class Hyperwallet {
    ...
    public function createUser(User $user) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users', array(), $user, array());
    ...
    public function getUser($userToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}', array('user-token' => $userToken), array());
        return new User($body);
    }
    /**
     * Update a user
    ...
    public function updateUser(User $user) {
        ...
        $body = $this->client->doPut('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}', array('user-token' => $user->getToken()), $user, array());
        return new User($body);
    }
    /**
     * List all users
    ...
    public function listUsers($options = array()) {
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users', array(), $options);
    ...
    public function getUserStatusTransition($userToken, $statusTransitionToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/status-transitions/{status-transition-token}', array(
    ...
    public function listUserStatusTransitions($userToken, array $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/status-transitions', array(
            'user-token' => $userToken
        ), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function getAuthenticationToken($userToken) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/authentication-token', array(
            'user-token' => $userToken,
        ), null, array());
    ...
    public function createPaperCheck($userToken, PaperCheck $paperCheck) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paper-checks', array('user-token' => $userToken), $paperCheck, array());
    ...
    public function getPaperCheck($userToken, $paperCheckToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paper-checks/{paper-check-token}', array(
            'user-token' => $userToken,
    ...
    public function updatePaperCheck($userToken, PaperCheck $paperCheck) {
        ...
        $body = $this->client->doPut('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paper-checks/{paper-check-token}', array(
            'user-token' => $userToken,
    ...
    public function listPaperChecks($userToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paper-checks', array('user-token' => $userToken), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createPaperCheckStatusTransition($userToken, $paperCheckToken, PaperCheckStatusTransition $transition) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paper-checks/{paper-check-token}/status-transitions', array(
            'user-token' => $userToken,
            'paper-check-token' => $paperCheckToken
        ), $transition, array());
    ...
    public function getPaperCheckStatusTransition($userToken, $paperCheckToken, $statusTransitionToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paper-checks/{paper-check-token}/status-transitions/{status-transition-token}', array(
            'user-token' => $userToken,
            'paper-check-token' => $paperCheckToken,
            'status-transition-token' => $statusTransitionToken
        ), array());
    ...
    public function listPaperCheckStatusTransitions($userToken, $paperCheckToken, array $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paper-checks/{paper-check-token}/status-transitions', array(
            'user-token' => $userToken,
            'paper-check-token' => $paperCheckToken
        ), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createTransfer(Transfer $transfer) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/transfers', array(), $transfer, array());
    ...
    public function getTransfer($transferToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/transfers/{transfer-token}', array('transfer-token' => $transferToken),
            array());
        return new Transfer($body);
    }
    /**
    ...
    public function listTransfers($options = array()) {
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/transfers', array(), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createTransferStatusTransition($transferToken, TransferStatusTransition $transition) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/transfers/{transfer-token}/status-transitions', array(
    ...
    public function createPayPalAccount($userToken, PayPalAccount $payPalAccount) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paypal-accounts', array('user-token' => $userToken), $payPalAccount, array());
    ...
    public function getPayPalAccount($userToken, $payPalAccountToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paypal-accounts/{paypal-account-token}', array(
            'user-token' => $userToken,
    ...
    public function listPayPalAccounts($userToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/paypal-accounts', array('user-token' => $userToken), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createPrepaidCard($userToken, PrepaidCard $prepaidCard) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/prepaid-cards', array('user-token' => $userToken), $prepaidCard, array());
    ...
    public function getPrepaidCard($userToken, $prepaidCardToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/prepaid-cards/{prepaid-card-token}', array(
            'user-token' => $userToken,
    ...
    public function updatePrepaidCard($userToken, PrepaidCard $prepaidCard) {
        ...
        $body = $this->client->doPut('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/prepaid-cards/{prepaid-card-token}', array(
            'user-token' => $userToken,
    ...
    public function listPrepaidCards($userToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/prepaid-cards', array('user-token' => $userToken), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createPrepaidCardStatusTransition($userToken, $prepaidCardToken, PrepaidCardStatusTransition $transition) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/prepaid-cards/{prepaid-card-token}/status-transitions', array(
            'user-token' => $userToken,
            'prepaid-card-token' => $prepaidCardToken
        ), $transition, array());
    ...
    public function getPrepaidCardStatusTransition($userToken, $prepaidCardToken, $statusTransitionToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/prepaid-cards/{prepaid-card-token}/status-transitions/{status-transition-token}', array(
            'user-token' => $userToken,
            'prepaid-card-token' => $prepaidCardToken,
            'status-transition-token' => $statusTransitionToken
        ), array());
    ...
    public function listPrepaidCardStatusTransitions($userToken, $prepaidCardToken, array $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/prepaid-cards/{prepaid-card-token}/status-transitions', array(
            'user-token' => $userToken,
            'prepaid-card-token' => $prepaidCardToken
        ), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createBankAccount($userToken, BankAccount $bankAccount) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-accounts', array('user-token' => $userToken), $bankAccount, array());
    ...
    public function getBankAccount($userToken, $bankAccountToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-accounts/{bank-account-token}', array(
            'user-token' => $userToken,
    ...
    public function updateBankAccount($userToken, BankAccount $bankAccount) {
        ...
        $body = $this->client->doPut('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-accounts/{bank-account-token}', array(
            'user-token' => $userToken,
    ...
    public function listBankAccounts($userToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-accounts', array('user-token' => $userToken), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createBankAccountStatusTransition($userToken, $bankAccountToken, BankAccountStatusTransition $transition) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-accounts/{bank-account-token}/status-transitions', array(
            'user-token' => $userToken,
            'bank-account-token' => $bankAccountToken
        ), $transition, array());
    ...
    public function getBankAccountStatusTransition($userToken, $bankAccountToken, $statusTransitionToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-accounts/{bank-account-token}/status-transitions/{status-transition-token}', array(
            'user-token' => $userToken,
            'bank-account-token' => $bankAccountToken,
            'status-transition-token' => $statusTransitionToken
        ), array());
    ...
    public function listBankAccountStatusTransitions($userToken, $bankAccountToken, array $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-accounts/{bank-account-token}/status-transitions', array(
            'user-token' => $userToken,
            'bank-account-token' => $bankAccountToken
        ), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createBankCard($userToken, BankCard $bankCard) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-cards', array('user-token' => $userToken), $bankCard, array());
    ...
    public function getBankCard($userToken, $bankCardToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-cards/{bank-card-token}', array(
            'user-token' => $userToken,
    ...
    public function updateBankCard($userToken, BankCard $bankCard) {
        ...
        $body = $this->client->doPut('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-cards/{bank-card-token}', array(
            'user-token' => $userToken,
    ...
    public function listBankCards($userToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-cards', array('user-token' => $userToken), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createBankCardStatusTransition($userToken, $bankCardToken, BankCardStatusTransition $transition) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-cards/{bank-card-token}/status-transitions', array(
            'user-token' => $userToken,
            'bank-card-token' => $bankCardToken
        ), $transition, array());
    ...
    public function getBankCardStatusTransition($userToken, $bankCardToken, $statusTransitionToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-cards/{bank-card-token}/status-transitions/{status-transition-token}', array(
            'user-token' => $userToken,
            'bank-card-token' => $bankCardToken,
            'status-transition-token' => $statusTransitionToken
        ), array());
    ...
    public function listBankCardStatusTransitions($userToken, $bankCardToken, array $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/bank-cards/{bank-card-token}/status-transitions', array(
            'user-token' => $userToken,
            'bank-card-token' => $bankCardToken
        ), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createTransferMethod($userToken, $jsonCacheToken, TransferMethod $transferMethod = null) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/transfer-methods', array('user-token' => $userToken), $transferMethod, array(), array(
    ...
    public function listBalancesForUser($userToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/balances', array('user-token' => $userToken), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function listBalancesForPrepaidCard($userToken, $prepaidCardToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/prepaid-cards/{prepaid-card-token}/balances', array(
            'user-token' => $userToken,
            'prepaid-card-token' => $prepaidCardToken
        ), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function listBalancesForAccount($programToken, $accountToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/programs/{program-token}/accounts/{account-token}/balances', array(
    ...
    public function createPayment(Payment $payment) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/payments', array(), $payment, array());
    ...
    public function getPayment($paymentToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/payments/{payment-token}', array('payment-token' => $paymentToken), array());
        return new Payment($body);
    }
    /**
     * List all payments
    ...
    public function listPayments($options = array()) {
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/payments', array(), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function createPaymentStatusTransition($paymentToken, PaymentStatusTransition $transition) {
        ...
        $body = $this->client->doPost('https://api.sandbox.hyperwallet.com/rest/v3/payments/{payment-token}/status-transitions', array(
    ...
    public function getPaymentStatusTransition($paymentToken, $statusTransitionToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/payments/{payment-token}/status-transitions/{status-transition-token}', array(
            'payment-token' => $paymentToken,
            'status-transition-token' => $statusTransitionToken
        ), array());
        return new PaymentStatusTransition($body);
    ...
    public function listPaymentStatusTransitions($paymentToken, array $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/payments/{payment-token}/status-transitions', array(
            'payment-token' => $paymentToken
        ), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function getProgram($programToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/programs/{program-token}', array('program-token' => $programToken), array());
    ...
    public function getProgramAccount($programToken, $accountToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/programs/{program-token}/accounts/{account-token}', array(
            'program-token' => $programToken,
            'account-token' => $accountToken
        ), array());
    ...
    public function getTransferMethodConfiguration($userToken, $country, $currency, $type, $profileType) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/transfer-method-configurations', array(), array(
            'userToken' => $userToken,
            'country' => $country,
            'currency' => $currency,
            'type' => $type,
    ...
    public function listTransferMethodConfigurations($userToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/transfer-method-configurations', array(), array_merge(array(
            'userToken' => $userToken,
        ), $options));
    ...
    public function listReceiptsForProgramAccount($programToken, $accountToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/programs/{program-token}/accounts/{account-token}/receipts', array(
            'program-token' => $programToken,
            'account-token' => $accountToken
        ), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function listReceiptsForUser($userToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/receipts', array(
            'user-token' => $userToken
        ), $options);
        return new ListResponse($body, function($entry) {
            return new Receipt($entry);
    ...
    public function listReceiptsForPrepaidCard($userToken, $prepaidCardToken, $options = array()) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/users/{user-token}/prepaid-cards/{prepaid-card-token}/receipts', array(
            'user-token' => $userToken,
            'prepaid-card-token' => $prepaidCardToken
        ), $options);
        return new ListResponse($body, function($entry) {
    ...
    public function getWebhookNotification($webhookNotificationToken) {
        ...
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/webhook-notifications/{webhook-notification-token}', array('webhook-notification-token' => $webhookNotificationToken), array());
    ...
    public function listWebhookNotifications($options = array()) {
        $body = $this->client->doGet('https://api.sandbox.hyperwallet.com/rest/v3/webhook-notifications', array(), $options);
        return new ListResponse($body, function($entry) {
